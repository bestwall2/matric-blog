    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-32 md:px-8">
      <div className="mx-auto max-w-[800px]">
        <header className="space-y-6 text-center animate-fade-in-up mb-20">
          <h1 className="font-heading text-4xl font-black text-white md:text-6xl">سياسة الخصوصية</h1>
          <p className="text-[#888888]">آخر تحديث: مايو 2026</p>
          <div className="mx-auto h-1 w-20 bg-[#e63946]" />
        </header>

        <div className="prose prose-invert prose-neutral max-w-none leading-[1.8] text-[#888888]">
          <section className="space-y-6 mb-12">
            <h2 className="font-heading text-2xl font-bold text-white">1. مقدمة وهويتنا</h2>
            <p>
          ...
          <section className="space-y-6 mb-12">
            <h2 className="font-heading text-2xl font-bold text-white">2. البيانات التي نجمعها</h2>
          ...
          <section className="space-y-6 mb-12 rounded-[16px] bg-[#111111] p-8 border border-white/5 border-r-4 border-r-[#e63946]">
            <h2 className="font-heading text-2xl font-bold text-white">3. Google AdSense وملفات تعريف الارتباط</h2>
            <p>
          ...
          <section className="space-y-6 mb-12">
            <h2 className="font-heading text-2xl font-bold text-white">4. حقوق المستخدم</h2>

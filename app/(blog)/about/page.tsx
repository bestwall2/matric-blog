  ...
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-32 md:px-8">
      <header className="space-y-6 text-center animate-fade-in-up">
        <h1 className="font-heading text-4xl font-black text-white md:text-6xl">من نحن</h1>
      ...
      <div className="mt-24 grid gap-12 md:grid-cols-2">
        <section className="space-y-6 rounded-[16px] bg-[#111111] p-10 border border-white/5">
          <h2 className="font-heading text-2xl font-bold text-white">رؤيتنا ورسالتنا</h2>
        ...
        <section className="space-y-6 rounded-[16px] bg-[#111111] p-10 border border-white/5">
          <h2 className="font-heading text-2xl font-bold text-white">معاييرنا التحريرية</h2>
          <p className="leading-[1.8] text-[#888888]">
      ...
      <section className="mt-24 rounded-[16px] bg-[#050505] p-10 md:p-16 border border-white/5 mesh-gradient">
        <div className="mb-12 text-center">
          <h2 className="font-heading text-3xl font-black text-white">فريق العمل</h2>
          <p className="mt-2 text-[#888888]">نخبة من المحررين المتميزين</p>
        </div>
        <div className="flex justify-center">
          <div className="flex flex-col items-center gap-6 max-w-sm text-center">
            <Avatar className="size-24 border-2 border-[#e63946] glow-red">
              <AvatarFallback className="bg-[#1a1a1a] text-3xl font-black text-white">M</AvatarFallback>
            </Avatar>
            <div>
              <h3 className="font-heading text-xl font-bold text-white">فريق MatricBlog</h3>
      ...
      <section className="mt-24 space-y-8 text-center">
        <h2 className="font-heading text-3xl font-black text-white">تواصل معنا</h2>
